...
export default function SignOut() {
    ...
    const handleCancel = () => {
        router.push('/admin'); // Cambia esto a la ruta que desees para regresar
    };
        ...
        <>
            <div className="min-h-screen flex items-center justify-center bg-gray-100 flex-col">
                <div className="max-w-md bg-white p-8 rounded-lg shadow-md" style={{ width: '90%' }}>
                    <h2 className="text-2xl font-semibold text-center mb-4">¿Seguro que deseas cerrar sesión?</h2>
                    <div className="flex space-x-4">
                        <button
                            onClick={handleCancel}
                            className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-md font-medium text-gray-700 bg-gray-200 hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400"
                        >
                            Cancelar
                        </button>
                        <button
