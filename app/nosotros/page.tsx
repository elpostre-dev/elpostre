            ...
            <div style={{ height: '92vh' }} className="bg-mainRosa-100 shadow-sm">
                <div className="mx-auto flex justify-center items-center h-full flex-col md:flex-row">
                    ...
                    <div className="flex flex-col justify-center items-center px-7 py-10 md:w-1/2">
                        <Image src={'/logos/logo_dorado.png'} alt="logo" height={180} width={360} />
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                            ...
                            {features.map((feature) => (
                                <div key={feature.name} className="relative pl-16">
                                    <dt className="text-base font-semibold leading-7 text-gray-900">
                                        <div className="absolute left-0 top-0 flex h-10 w-10 items-center justify-center rounded-lg bg-mainRojo-100">
                                            <svg className="h-6 w-6 text-white" aria-hidden="true" viewBox="0 0 20 20" fill="currentColor">
                                                <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm0-2a6 6 0 100-12 6 6 0 000 12zm0-10a2 2 0 11-4 0 2 2 0 014 0z" clipRule="evenodd" />
                                            </svg>
                                        </div>
                                        {feature.name}
                                    </dt>
                    ...
                    <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-12 max-md:max-w-lg mx-auto py-10">
                        ...
                        <div className="rounded-xl group p-8 text-center text-mainRojo-100 hover:bg-mainRojo-100 hover:text-white shadow-xl hover:cursor-pointer transition duration-300">
                            ...
                            <p className="text-gray-600 group-hover:text-gray-200 text-sm">Tailor our product to suit your needs.</p>
                        </div>
                        ...
                        <div className="rounded-xl group p-8 text-center text-mainRojo-100 hover:bg-mainRojo-100 hover:text-white shadow-xl hover:cursor-pointer transition duration-300">
                            ...
                            <p className="text-gray-600 group-hover:text-gray-200 text-sm">Your data is protected by the latest security measures.</p>
                        </div>
                        ...
                        <div className="rounded-xl group p-8 text-center text-mainRojo-100 hover:bg-mainRojo-100 hover:text-white shadow-xl hover:cursor-pointer transition duration-300">
                            ...
                            <p className="text-gray-600 group-hover:text-gray-200 text-sm">24/7 customer support for all your inquiries.</p>
                        </div>
