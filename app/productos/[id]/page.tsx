                            ...
                            <div className="grid items-start grid-cols-1 lg:grid-cols-2 gap-10">
                                ...
                                <div>
                                    ...
                                    <div className="flex flex-wrap items-start gap-4">
                                        <div>
                                            <h2 className="text-2xl font-extrabold text-gray-800">{producto.nombre}</h2>
                                    ...
                                    <div className="flex flex-wrap gap-4 items-start">
                                        <div>
                                            ...
                                            <p className="text-gray-400 text-xl mt-1"><i>$42</i> <span className="text-sm ml-1">Tax included</span></p>
                                        </div>
                                    ...
                                    <div className="flex flex-wrap gap-4">
                                        <button type="button" className="min-w-[200px] px-4 py-3 bg-gray-800 hover:bg-gray-900 text-white text-sm font-bold rounded">Buy now</button>
                                        <button type="button" className="min-w-[200px] px-4 py-2.5 border border-gray-800 bg-transparent hover:bg-gray-50 text-gray-800 text-sm font-bold rounded">Add to cart</button>
                                    </div>
