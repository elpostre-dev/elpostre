...
export default function BrowniesContent() {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                const res = await fetch(`/api/getProductsByCategory?categoryId=${3}`);
                if (!res.ok) throw new Error(`Failed to fetch products for category ${3}`);
