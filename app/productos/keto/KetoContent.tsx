...
export default function KetoContent() {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                const res = await fetch(`/api/getProductsByCategory?categoryId=${5}`);
                if (!res.ok) throw new Error(`Failed to fetch products for category ${5}`);
            ...
            <div className="px-10 py-5 bg-red-50">
                <Breadcrumb>
                    <BreadcrumbList>
                        ...
                        <BreadcrumbSeparator />
                        <BreadcrumbItem>
                            <BreadcrumbPage>Keto</BreadcrumbPage>
                        </BreadcrumbItem>
                    </BreadcrumbList>
                </Breadcrumb>
            </div>
