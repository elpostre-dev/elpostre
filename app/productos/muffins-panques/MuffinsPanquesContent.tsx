...
export default function MuffinsPanquesContent() {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                const res = await fetch(`/api/getProductsByCategory?categoryId=${6}`);
                if (!res.ok) throw new Error(`Failed to fetch products for category ${6}`);
            ...
            <div className="px-10 py-5 bg-red-50">
                <Breadcrumb>
                    <BreadcrumbList>
                        ...
                        <BreadcrumbSeparator />
                        <BreadcrumbItem>
                            <BreadcrumbPage>Muffins y Panqués</BreadcrumbPage>
                        </BreadcrumbItem>
                    </BreadcrumbList>
                </Breadcrumb>
            </div>
