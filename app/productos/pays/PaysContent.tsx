...
export default function PaysContent() {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                const res = await fetch(`/api/getProductsByCategory?categoryId=${2}`);
                if (!res.ok) throw new Error(`Failed to fetch products for category ${2}`);
