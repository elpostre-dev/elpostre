        ...
        <>
            <div className="flex flex-col min-[500px]:flex-row min-[500px]:items-center gap-5 py-6 border-b border-gray-200 group" key={item.nombre}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-7 w-full">
                    ...
                    {/* cantidad */}
                    <div className="flex items-center justify-between w-full h-full max-md:mt-3 md:col-span-2">
                    ...
                    {/* precio */}
                    <div className="flex items-center justify-start max-md:mt-3 h-full md:col-span-1 mx-auto md:mx-0">
                    ...
                    {/* borrar */}
                    <div className="flex items-center md:justify-center max-md:mt-3 h-full md:col-span-1 mx-auto md:mx-0">
